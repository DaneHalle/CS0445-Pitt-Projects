...
public class Driver {
	public static void main(String[] args) {
		...
		System.out.println("geometricMean:   " + testMean1);
		...
		System.out.println("geometricMean:   " + testMean2);
		...
		System.out.println("geometricMean:   " + testMean3);
		...
		System.out.println("geometricMean:   " + testMean4);
		System.out.println("it evalutes to:  " + testMean4.evaluate(testVars4));

		System.out.println("===================================================");

		Map<String, Double> errorCheck=new HashMap<>();
		Expression errorCheckExp=Expression.quickParse("x");
		System.out.println("evaluate:		 " + errorCheckExp.evaluate(errorCheck)); 
		//Will cause the program to crash for the sake of SCIENCE...Actually just error checking
